...
/* BF_neural predictor config () */
static int BF_neural_nelt = 3;
static int BF_neural_config[3] = 
...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_string(odb, "-bpred",
		 "branch predictor type {nottaken|taken|perfect|bimod|BF_neural|2lev|comb}",
  ...
  opt_reg_int_list(odb, "-bpred:2lev",
		   ...
		   /* default */twolev_config,
                   /* print */TRUE, /* format */NULL, /* !accrue */FALSE);
  opt_reg_int_list(odb, "-bpred:BF_neural",
		   "BF_neural predictor config (<nr_of_perceptrons> <nr_of_weight_bits> <history_length>)",
		   BF_neural_config, BF_neural_nelt, &BF_neural_nelt,
		   /* default */BF_neural_config,	
		  ...
		  int argc, char **argv)        /* command line arguments */
{
  ...
  if (!mystricmp(pred_type, "perfect"))
	...
	else if (!mystricmp(pred_type, "BF_neural"))
    {
      /* BF_neural predictor, bpred_create() checks BTB_SIZE */
    if (BF_neural_nelt != 3)
	...
	fatal("bad btb config (<num_sets> <associativity>)");
	  ...
	  pred = bpred_create(BPredPerceptron,
			  /* nr of perceptrons */ BF_neural_config[0],
			  /* nr of weight bits */ BF_neural_config[1],0,0,	
			  /* history length */    BF_neural_config[2],0,
			  /* btb sets */btb_config[0],
			  /* btb assoc */btb_config[1],
			  /* ret-addr stack size */ras_size);
    }
